...
if (isset($_SESSION["ad_session"])) {
    ...
    <h2 class="text-center" style="font-family: 'Candara', cursive; color: #fafafa; font-size: 60px; background-color: #030303; border: 3px dashed rgb(74, 204, 255);">View Category </h2>
    <div class="table-responsive" style="background-color: #030303;">
        <center>
            <table class="table table-bordered table-sm" style="border: 3px dashed rgb(74, 204, 255); color: #fafafa; width: 80%;">
