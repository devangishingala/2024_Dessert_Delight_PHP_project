...
<div class="login-page">
  <div class="form">
    <form class="login-form" action="login.php" method="post">
     ...
     <button class="login-button"  name="submit" type="submit" style="width: 270px; height: 45px; background-color: #AFEEEE;"><a href="afterlogin.php">Login</a></button>
...
if(isset($_REQUEST["submit"])) {
    ...
    mysqli_query($con, "INSERT INTO userlogin (name, password) VALUES ('$name', '$psw')");
